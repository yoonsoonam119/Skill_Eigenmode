#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Sat  4 May 14:00:43 BST 2024      
date_start=`date +%s`
...
export OMP_NUM_THREADS=4
 nice -n 10 /users/hert5217/anaconda3/envs/gputorch/bin/python3 train_data_agd_transformer.py --beta 0.9 --lr 0.00005 --wd 0.00001 --numskills 5 --alpha 1.9
  echo ---------------                                           
