...
if __name__ == '__main__':
    ...
    parser.add_argument("-p", "--opt", help="opts", type=str, default='agd')
    ...
    parser.add_argument("-lr", "--lr", help="zero_mean", type=float, default=1.0)
    parser.add_argument("-beta", "--beta", help="zero_mean", type=float, default=0.0)
    parser.add_argument("-wd", "--wd", help="zero_mean", type=float, default=0.01)
    parser.add_argument("-init", "--init", help="zero_mean", type=float, default=1.0)
    parser.add_argument("-model", "--model", help="zero_mean", type=str, default='FCN')
